      ...
      render(){
          return(
            <View  style={styles.item}>
                ...
                <View style={styles.secondaryViewStyle}>
                    <View style={styles.dobViewStyle}>
                        <Text style={styles.secondaryRowTitleStyle}>Weight on Birth:</Text> <Text style={styles.secondaryRowTextStyle}> { this.props.babyRec.birthWeight }</Text>
                    </View>
                    <View style={styles.pobViewStyle}>
                        <Text style={styles.secondaryRowTitleStyle}>Length on Birth:</Text> <Text style={styles.secondaryRowTextStyle}> { this.props.babyRec.lengthAtBirth }</Text>
                    </View>
                </View>
